...
&nbsp;
	...
	Record was created <?php echo $doc->reg_date? $doc->reg_date: $doc->data_entry; echo $doc->iv_date?';':'; Was not'; echo " Verified $doc->iv_date; Last saved $doc->last_save"; ?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
	...
	?>
	<label><input type="radio" name="pending" value="0" /> <strong>Verified</strong></label> &nbsp; <label><input type="radio" name="pending" value="2" />  Incomplete</label>  <label><input type="radio" name="pending" checked value="1" />  Unverified</label>
	<?php
	} ?></td>
    <td>&nbsp;</td>
  </tr>
